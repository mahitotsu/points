...
import com.mahitotsu.points.persistence.account.AccountWithdrawalEventEntity.Payload;
...
@Entity(name = "AccountWithdrawalEvent")
@ToString(callSuper = true)
@EqualsAndHashCode(callSuper = true)
public class AccountWithdrawalEventEntity extends EventEntity<Payload> {
